                ...
                <View style={styles.cardInfo}>
                    ...
                    <View style={styles.metricsRow}>
                        <View style={styles.metricItem}>
                            ...
                            <Text style={styles.metricText} numberOfLines={1}>{item.hospitalName}</Text>
                        </View>
                        <View style={styles.metricItem}>
                            <MaterialCommunityIcon name="water-outline" size={14} color="#E11D48" />
                            <Text style={styles.metricText}>{item.unitsRequired} Unit{item.unitsRequired > 1 ? 's' : ''}</Text>
                        </View>
                    </View>
                    ...
                    {donorCount > 0 ? (
                        <View style={styles.matchesRow}>
                            <View style={styles.matchCircle}>
                                <MaterialIcon name="group" size={14} color="#B62022" />
                            </View>
                            <Text style={styles.matchLabel}>
                                <Text style={styles.matchCountHighlight}>{donorCount}</Text> {donorCount === 1 ? 'donor' : 'donors'} found
                            </Text>
                        </View>
                    ) : isCompleted ? (
                        <View style={styles.matchesRow}>
...
const styles = StyleSheet.create({
    ...
    requestTitle: { fontSize: 17, fontWeight: '800', color: '#0F172A', flex: 1, marginRight: 10 },
    timeText: { fontSize: 11, color: '#94A3B8', fontWeight: '700' },
    metricsRow: { flexDirection: 'row', alignItems: 'center', marginBottom: 12, gap: 12 },
    metricItem: { flexDirection: 'row', alignItems: 'center', gap: 4 },
    metricText: { fontSize: 12, color: '#64748B', fontWeight: '600' },
    ...
    viewDetailsText: { color: '#B62022', fontWeight: '800', fontSize: 13, marginRight: 2, textTransform: 'uppercase', letterSpacing: 0.5 },
    viewDetailsTextOutline: { color: '#94A3B8' },
    completedCard: { opacity: 0.8, backgroundColor: '#FDFDFD' },
    matchCountHighlight: { color: '#B62022', fontWeight: '800' },
    pulseDot: {
        width: 8,
        height: 8,
        borderRadius: 4,
